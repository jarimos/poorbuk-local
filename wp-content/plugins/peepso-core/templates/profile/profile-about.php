...
<section id="mainbody" class="ps-page-unstyled">
	<section id="component" role="article" class="ps-clearfix">
		...
		<?php if (false) { ?>
		<div class="ps-list--column">
			<div class="ps-list__item" style="text-align:right">
				<button class="ps-btn ps-js-btn-edit-all"><?php _e('Edit All', 'peepso-core'); ?></button>
				<button class="ps-btn ps-btn-primary ps-js-btn-save-all" style="display:none"><?php _e('Save All', 'peepso-core'); ?></button>
			</div>
		</div>
		<?php } ?>
