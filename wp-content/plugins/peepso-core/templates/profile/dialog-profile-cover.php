...
<div id="dialog-upload-cover">
	...
	<div id="dialog-upload-cover-content">
		...
		<ul class="ps-list <?php if ($PeepSoUser->has_cover()) { echo 'ps-list-half'; } ?> upload-cover">
			...
			<li class="ps-list-item">
				<a href="#" onclick="profile.remove_cover_photo(<?php echo $PeepSoUser->get_id(); ?>); return false;" class="ps-btn ps-btn-danger ps-full"><?php _e('Remove Cover Photo', 'peepso-core'); ?></a>
			</li>
			<?php } ?>
