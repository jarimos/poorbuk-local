			...
			<div class="ps-page-half upload-avatar">
				...
				<div class="ps-js-has-avatar" <?php echo $PeepSoUser->has_avatar() ? '' : 'style="display:none"' ?>>
					...
					<div class="ps-page-footer">
						<a href="#" onclick="profileavatar.updateThumbnail(); return false;" id="" class="update-thumbnail ps-btn ps-btn-small ps-full-mobile ps-avatar-crop ps-js-crop-avatar"><?php _e('Crop Image', 'peepso-core'); ?></a>
						<a href="#" onclick="profileavatar.saveThumbnail(); return false;" id="" class="update-thumbnail-save ps-btn ps-btn-small ps-btn-primary ps-full-mobile" style="display: none;"><?php _e('Save Thumbnail', 'peepso-core'); ?></a>
					</div>
				</div>
