<div class="ps-location-wrapper ps-js-location-wrapper" style="display:block">
	<div class="ps-location ps-js-location ps-clearfix" style="position:relative;border:0 none">
		...
		<div class="ps-location-result ps-js-location-result">
			...
			<a href="#" class="ps-btn ps-btn-small ps-btn-primary ps-js-select" style="top:42px"><?php _e('Select', 'peepso-core'); ?></a>
			<a href="#" class="ps-btn ps-btn-small ps-btn-danger ps-js-remove" style="top:42px"><?php _e('Remove', 'peepso-core'); ?></a>
		</div>
	</div>
