<div class="ps-location-wrapper ps-js-location-wrapper">
	<div class="ps-location ps-js-location ps-clearfix">
		...
		<div class="ps-location-result ps-js-location-result">
			...
			<a href="#" class="ps-btn ps-btn-small ps-btn-primary ps-js-select"><?php _e('Select', 'peepso-core'); ?></a>
			<a href="#" class="ps-btn ps-btn-small ps-btn-danger ps-js-remove"><?php _e('Remove', 'peepso-core'); ?></a>
		</div>
	</div>
