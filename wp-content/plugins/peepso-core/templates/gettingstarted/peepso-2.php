<div class="psa-starter__page psa-starter__page--split psa-starter__page--customize">
	...
	class PeepSoGettingStartedPeepSoStep2 {
			...
			<?php } else { ?>
				<div class="psa-starter__header psa-starter__header--option">
					...
					<?php if('text' == $type) { ?>
						...
						<button class="button ps-js-btn ps-js-cancel" style="display:none"><?php _e('Cancel', 'peepso-core'); ?></button>
						<button class="button button-primary ps-js-btn ps-js-save" style="display:none"><?php _e('Save', 'peepso-core'); ?></button>
					...
					<?php if('image' == $type) { ?>
						...
						<button class="button button-primary ps-js-btn ps-js-select"><?php _e('Select Image', 'peepso-core'); ?></button>
						<button class="button button-link-delete ps-js-btn ps-js-remove" <?php echo $is_default ? 'style="display:none"' : '' ?>><?php _e('Remove Image', 'peepso-core'); ?></button>
						...
						<span class="ps-js-notice" style="line-height:26px; <?php echo $is_default ? '' : 'display:none' ?>"><?php _e('Default image selected', 'peepso-core'); ?></span>
		...
		$gs::f(
				...
				__('Encourage people to join your community with the following options. These are shown as a part of the landing page - [peepso_activity] shortcode.<br/>Please note, the landing page is visible only users who are not logged in. You can take a look at it in incognito mode in your browser.','peepso-core'),
				'separator'
		);
