...
<span class="ps-dropdown ps-dropdown--right ps-dropdown--stream-filter ps-js-dropdown ps-js-activitystream-filter" data-id="peepso_search_hashtag">
	<a class="ps-btn ps-btn--small ps-js-dropdown-toggle" aria-haspopup="true" style="vertical-align:top">
		...
		><?php echo __('#', 'peepso-core'); ?></span>
	</a>
	<div role="menu" class="ps-dropdown__menu ps-js-dropdown-menu">
		<div class="ps-dropdown__actions">
			#<input maxlength="<?php echo PeepSo::get_option('hashtags_max_length',16);?>" type="text" class="ps-input ps-input--small ps-full"
		...
		<div class="ps-dropdown__actions">
			...
			<button class="ps-btn ps-btn--small ps-btn-primary ps-js-search-hashtag"><?php _e('Apply', 'peepso-core'); ?></button>
		</div>
	</div>
</span>
