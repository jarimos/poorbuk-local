...
<div id="ps-dialogs" style="display:none">
		...
		<div data-type="stream-newcomment" class="cstream-form stream-form wallform " data-formblock="true" style="display: block;">
			<form class="reset-gap">
				<div class="cstream-form-submit">
					<a href="#" data-action="cancel" onclick="return activity.comment_cancel(); return false;" class="ps-btn ps-btn-small cstream-form-cancel"><?php _e('Cancel', 'peepso-core'); ?></a>
	...
	<span id="report-error-empty-reason"><?php _e('ERROR: Please fill Reason for Report.', 'peepso-core'); ?></span>
