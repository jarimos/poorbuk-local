                    ...
                    <form id="recoverpasswordform" name="recoverpasswordform" action="<?php PeepSo::get_page('recover'); ?>?submit" method="post" class="ps-form">
                        ...
                        <div class="ps-form__container">
                            <div class="ps-form__row">
                                <label for="email" class="ps-form__label"><?php _e('New Password:', 'peepso-core'); ?>
                                    <span class="required-sign">&nbsp;*<span></span></span>
                                </label>
                                <div class="ps-form__field">
                                    <input class="ps-input" type="password" name="pass1" placeholder="<?php _e('New Password', 'peepso-core'); ?>" required />
                                    <div class="ps-form__field-desc lbl-descript"><?php _e('Enter your desired password', 'peepso-core'); ?></div>
                                    <ul class="ps-form__error" style="display:none"></ul>
                                </div>
                            </div>

                            <div class="ps-form__row">
                                <label for="email" class="ps-form__label"><?php _e('Repeat new password:', 'peepso-core'); ?>
                                    <span class="required-sign">&nbsp;*<span></span></span>
                                </label>
                                <div class="ps-form__field">
                                    <input class="ps-input" type="password" name="pass2" placeholder="<?php _e('Repeat new password', 'peepso-core'); ?>" required />
                                    <div class="ps-form__field-desc lbl-descript"><?php _e('Please re-enter your password', 'peepso-core'); ?></div>
                                    <ul class="ps-form__error" style="display:none"></ul>
                                </div>
                            </div>
