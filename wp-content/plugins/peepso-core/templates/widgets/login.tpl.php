          ...
          <?php } else { ?>
            <div class="ps-form__row ps-form__row--group">
                ...
                <div class="ps-form__field ps-form__field--group ps-js-password-field">
                    ...
                    <input class="ps-input ps-full" type="password" name="password" placeholder="<?php _e('Password', 'peepso-core'); ?>" mouseev="true" autocomplete="off" keyev="true" clickev="true" />
                </div>
                ...
                <div class="ps-form__field ps-form__field--group ps-js-tfa-field" style="display:none">
                    ...
                    <input class="ps-input ps-full" type="text" name="two_factor_code" placeholder="<?php _e('TFA code', 'peepso-core'); ?>" mouseev="true" autocomplete="off" keyev="true" clickev="true" data-ps-extra="1" />
                </div>
                <?php } ?>
