...
class PeepSoFieldTextDate extends PeepSoFieldText {
	...
	protected function _render_form_input( )
	{
		...
		// Datepicker input
		$ret .= '<input data-date-range-min="'.$date_range_min.'" data-date-range-max="'.$date_range_max.'" type="text" class="datepicker" value="' . $val . '"' . $this->_render_input_args()
		      . ' title="' . __('Set date', 'peepso-core') . '" readonly="readonly"'
		      . ' data-value="' . $this->value . '" readonly="readonly"'
		      . ' onkeydown="return profile.field_keydown(this,event);">';

		// Datepicker toggle button
		$ret .= '<button class="ps-btn ps-btn-small ps-icon-calendar"'
