...
class PeepSoWidgetLogin extends WP_Widget
{
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('view_option'); ?>">
                <?php _e('View option', 'peepso-core'); ?>
                <select class="widefat" id="<?php echo $this->get_field_id('view_option'); ?>"
                        name="<?php echo $this->get_field_name('view_option'); ?>">
                    <option value="vertical"><?php _e('Vertical', 'peepso-core'); ?></option>
                    <option value="horizontal" <?php if('horizontal' === $view_option) echo ' selected="selected" ';?>><?php _e('Horizontal', 'peepso-core'); ?></option>
                </select>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['view_option'] = $new_instance['view_option'];
