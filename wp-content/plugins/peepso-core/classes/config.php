...
class PeepSoConfig
{
	...
	public function get_tabs()
	{
		$default_tabs = array(
            ...
            'appearance' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/settings_appearance_icon.svg',
            ...
            'postbox' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/settings_postbox.svg',
                'tab' => 'postbox',
                'description' => '',
            ...
            'markdown' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/settings_markdown.svg',
                'tab' => 'markdown',
            ...
            'blogposts' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/blogposts_icon.svg',
                'tab' => 'blogposts',
                'description' => '',
        ...
        'email' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/settings_email_icon.svg',
				'tab' => 'email',
            ...
            'navigation' => array(
                'label' => __('Navigation', 'peepso-core'),
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/navigation_icon.svg',
                'tab' => 'navigation',
                'description' => '',
            ...
            'network' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/settings_ajax.svg',
                'tab' => 'network',
                'description' => '',
            ...
            'advanced' => array(
                ...
                'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/settings_advanced_icon.svg',
                'tab' => 'advanced',
	...
	public function config_save()
	{
        ...
        global $wpdb;
        $wpdb->query("DELETE FROM {$wpdb->prefix}options WHERE option_name LIKE '_transient_peepso_license_%'");
        $wpdb->query("DELETE FROM {$wpdb->prefix}options WHERE option_name LIKE '_site_transient_peepso_license_%'");
