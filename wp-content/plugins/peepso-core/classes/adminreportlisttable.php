	...
	public function get_column_data($item, $column_name)
	{
		switch ($column_name)
		{
			...
			case 'rep_by':
						...
						<div class="psa-report__list">
							...
							<div class="psa-report__item">
								...
								<div class="psa-report__item-header">
									<a href="<?php echo $user->get_profileurl(); ?>" target="_blank" arialabel="<?php _e('User profile', 'peepso-core'); ?>">
								...
								<div class="psa-report__item-reason">
									<strong><?php _e('Reason for Report:', 'peepso-core'); ?></strong> <?php echo $rep_by['rep_reason'] ?>
								</div>
							</div>
							<?php } ?>
						</div>
					...
					<a class="thickbox" name="<?php esc_attr_e('Reported By', 'peepso-core'); ?>"
