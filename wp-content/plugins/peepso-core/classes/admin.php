...
class PeepSoAdmin
{
    ...
    const TRANS_CONNECT_TIMEOUT = 'peepso_com_timeout';
    const TRANS_CONNECT_TIMEOUT_COUNT = 'peepso_com_timeount_count';
...
//	}
	...
	public function enqueue_scripts()
	{
		...
		wp_localize_script('peepso-core', 'peepsodata', $aData);
...
//		);
	...
	public function system_check()
    {
        ...
        if(PHP_SESSION_DISABLED == $php_sessions) {
            $messages['errors'][] = __('PHP session suppport is required','peepso-core');
        }
        ...
        if(10 <= (int) get_transient(PeepSoAdmin::TRANS_CONNECT_TIMEOUT_COUNT)) {
