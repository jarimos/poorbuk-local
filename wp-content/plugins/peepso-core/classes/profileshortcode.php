...
class PeepSoProfileShortcode
{
    ...
    public function enqueue_scripts()
    {
        ...
        // profile management
        wp_register_script('peepso-profile', PeepSo::get_asset('js/profile.min.js'), array('peepso'), PeepSo::PLUGIN_VERSION, TRUE);
        wp_localize_script('peepso-profile', 'peepsoprofiledata', array(
            'profile_deletion_popup_content' => PeepSoTemplate::exec_template('profile', 'dialog-profile-deletion', array(), TRUE),
            'profile_account_data_popup_content' => PeepSoTemplate::exec_template('profile', 'dialog-profile-request-account-data', array(), TRUE),
            'profile_download_account_data_popup_content' => PeepSoTemplate::exec_template('profile', 'dialog-profile-download-account-data', array(), TRUE),
            'profile_delete_account_data_archive_popup_content' => PeepSoTemplate::exec_template('profile', 'dialog-profile-delete-account-data-archive', array(), TRUE),
        ));
        wp_enqueue_script('peepso-profile');
