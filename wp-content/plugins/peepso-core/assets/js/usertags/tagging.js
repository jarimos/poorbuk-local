(function( $, _, peepso, factory ) {
	...
	peepso.observer.addFilter( 'peepso_postbox_beautifier', function( html, $textarea ) {
...
PsTagging.prototype.dropdown_update = function( query, data ) {
	...
	for ( i = 0; i < data.length; i++ ) {
		...
		html += '<a href="#" onclick="return false;"><div class="ps-avatar"><img src="' + data[i].avatar + '"></div><span>' + data[i].name + '</span></a>';
		html += '</div>';
	}
